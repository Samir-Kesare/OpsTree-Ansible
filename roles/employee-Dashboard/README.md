...
This document is intended to streamline the process of setting up the Employee API Grafana Dashboard on the target PGA server. It aims to simplify the steps involved and provide clarity on the role created and utilized for this purpose.
***
...
<img width="575" alt="Screenshot 2024-04-16 at 4 26 13 PM" src="https://github.com/CodeOps-Hub/Ansible/assets/156056349/05981d5f-4215-4e0d-9f00-f341a5b82c3f">
...
### employee-grafana-dashboard.yml file
...
## Employee-Grafana-Dashboard Role
...
<details>
<summary> Click here to see addDashboard.yml file</summary>
<br>
...
```shell
---
# tasks file for frontendGrafanaDashboard
- name: Include tasks for Employee 
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "rate(promhttp_metric_handler_requests_total{job=\"employee_metrics\", code=\"200\"}[5m])",
          "instant": false,
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "rate(promhttp_metric_handler_requests_total{job=\"employee_metrics\"}[5m])",
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "rate(go_sched_latencies_seconds_total_sum[5m]) / rate(go_sched_latencies_seconds_total_count[5m])",
          "instant": false,
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "rate(promhttp_metric_handler_requests_total{job=\"employee_metrics\"}[1m]) * 60",
          "instant": false,
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
      ...
      "targets": [
        {
          ...
          "editorMode": "code",
          "expr": "sum(rate(promhttp_metric_handler_requests_total{job=\"employee_metrics\"}[5m])) by (instance) *10000",
          "instant": false,
          "legendFormat": "__auto",
          "range": true,
          "refId": "A"
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 1,
              "legendFormat": "CPU {% raw %}{{ cpu }}{% endraw %}",
              "range": true,
              "refId": "B",
              "step": 240
            },
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{ type }}{% endraw %} - {% raw %}{{ info }}{% endraw %}",
              "refId": "A",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{ name }}{% endraw %} Connections",
              "refId": "A",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Reads completed",
              "refId": "A",
              "step": 240
            },
            {
              ...
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Writes completed",
              "refId": "B",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "format": "time_series",
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Read bytes",
              "refId": "A",
              "step": 240
            },
            {
              ...
              "format": "time_series",
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Written bytes",
              "refId": "B",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Read wait time avg",
              "refId": "A",
              "step": 240
            },
            {
              ...
              "interval": "",
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Write wait time avg",
              "refId": "B",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Read merged",
              "refId": "A",
              "step": 240
            },
            {
              ...
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Write merged",
              "refId": "B",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - IO",
              "refId": "A",
              "step": 240
            },
            {
              ...
              "interval": "",
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - discard",
              "refId": "B",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - IO now",
              "refId": "A",
              "step": 240
            }
          ],
          ...
          "targets": [
            {
              ...
              "interval": "",
              "intervalFactor": 4,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Discards completed",
              "refId": "A",
              "step": 240
            },
            {
              ...
              "interval": "",
              "intervalFactor": 1,
              "legendFormat": "{% raw %}{{device}}{% endraw %} - Discards merged",
              "refId": "B",
              "step": 240
            }
          ],
  ...
  "templating": {
    "list": [
      ...
      },
      {
        "current": {
          "selected": false,
          "text": "172.31.51.23:9100",
          "value": "172.31.51.23:9100"
        },
        "datasource": {
          "type": "prometheus",
          "uid": "${datasource}"
...
---
editor_name : "Vidhi"
grafana_api_key: "glsa_1Q2NhHmeQc80hCXp1DX1vaolDD8RzaaK_4dd9f34e"
grafana_url: http://100.26.165.160:3000
json_file_template_src: "Employee-API.json.j2"
json_file_dest: "/home/ubuntu/Employee-API.json"
...
### Role Execution
<img width="1040" alt="Screenshot 2024-04-16 at 4 06 02 PM" src="https://github.com/CodeOps-Hub/Ansible/assets/156056349/f714d269-a2b7-4f18-aad7-aef3bf41767f">
...
<img width="1328" alt="Screenshot 2024-04-16 at 2 29 11 AM" src="https://github.com/CodeOps-Hub/Ansible/assets/156056349/21baa93e-1bc0-4922-8fa2-a33d28c1cb4f">

***

# Conclusion

This guide provides a comprehensive walkthrough for integrating the Employee Grafana Dashboard using Ansible. Following these instructions enables you to seamlessly visualize and monitor your Employee API Server within your AWS infrastructure. By leveraging this streamlined process, you can efficiently enhance your monitoring capabilities and ensure optimal performance of your server environment.
...
|     Name         | Email  |
| -----------------| ------------------------------------ |
| Vidhi Yadav    | vidhi.yahdhav.snaatak@mygurukulam.co |
***
